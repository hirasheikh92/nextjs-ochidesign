...
const Footer = () => {
  return (
    <footer className=" flex flex-col w-full py-10  bg-white rounded-tr-3xl rounded-tl">
      ...
      <div className="grid md:grid-cols-12 md:items-end mt-5 px-10">
        <div className="mb-40 md:mb-0 md:col-span-5 col-span-6 ">
          <Link className="inline-flex" href="https://ochi.design">
            <svg
              width="72"
              height="30"
              viewBox="0 0 72 30"
